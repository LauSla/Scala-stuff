...
object DBTest extends App {
  ...
  val url = "jdbc:sqlite:C:/Users/User/SQL/chinook.db" //you need to adjust your absolute url here
  ...
  //TODO create Artists Case Class --done
  ...
  val filteredArtists = artistResults.filter(row => row.Name.startsWith("A"))
  filteredArtists.foreach(println)
